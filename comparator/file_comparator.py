...
from reports.report_methods import total_report
from utils.colors import Colors
from comparator.sheet_comparator import compare_sheets
from configurator import package_report_path, package1_directory, package2_directory, errors, one_file_report,print_total_table


def compare_dirictory(create_reports):
